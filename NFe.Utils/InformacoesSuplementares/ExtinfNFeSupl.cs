...
namespace NFe.Utils.InformacoesSuplementares
{
    ...
    public static class ExtinfNFeSupl
    {
        ...
        private static List<EnderecoConsultaPublicaNfce> CarregarUrls()
        {
            ...
            {
                new EnderecoConsultaPublicaNfce(Estado.AC, TipoAmbiente.taProducao, TipoUrlConsultaPublica.UrlQrCode, "www.sefaznet.ac.gov.br/nfce/consulta"),
                ...
                new EnderecoConsultaPublicaNfce(Estado.AC, TipoAmbiente.taHomologacao, TipoUrlConsultaPublica.UrlQrCode, "www.sefaznet.ac.gov.br/nfce/consulta"),
